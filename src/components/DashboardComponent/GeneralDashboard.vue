      ...
      <main>
        ...
        >
          <div class="btn-toolbar dropdown">
            ...
            <div
              class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-0"
            >
              <a class="dropdown-item fw-normal rounded-top" href="#"
                ><span class="fas fa-tasks"></span>New Task</a
              >
              <a class="dropdown-item fw-normal" href="#"
                ><span class="fas fa-cloud-upload-alt"></span>Upload Files</a
              >
              <a class="dropdown-item fw-normal" href="#"
                ><span class="fas fa-user-shield"></span>Preview Security</a
              >
              <div role="separator" class="dropdown-divider my-0"></div>
              <a class="dropdown-item fw-normal rounded-bottom" href="#"
                ><span class="fas fa-rocket text-danger"></span>Upgrade to
                Pro</a
              >
            </div>
          </div>
            ...
            <div class="card bg-secondary-alt shadow-sm">
              ...
              >
                ...
                <div class="d-flex ms-auto">
                  <a href="#" class="btn btn-secondary text-dark btn-sm me-2"
                    >Month</a
                  >
            ...
            <div class="card border-light shadow-sm">
              <div class="card-body">
                <div class="row d-block d-xl-flex align-items-center">
                  ...
                  >
                    <div
                      class="ct-chart-traffic-share ct-golden-section ct-series-a"
                    ></div>
                  </div>
                  <div class="col-12 col-xl-7 px-xl-0">
                    <h2 class="h5 mb-3">Traffic Share</h2>
                    <h6 class="fw-normal text-gray">
                      <span class="icon w-20 icon-xs icon-secondary me-1"
                        ><span class="fas fa-desktop"></span
                      ></span>
                      Desktop <a href="#" class="h6">60%</a>
                    </h6>
                    <h6 class="fw-normal text-gray">
                      <span class="icon w-20 icon-xs icon-primary me-1"
                        ><span class="fas fa-mobile-alt"></span
                      ></span>
                      Mobile Web <a href="#" class="h6">30%</a>
                    </h6>
                    <h6 class="fw-normal text-gray">
                      <span class="icon w-20 icon-xs icon-tertiary me-1"
                        ><span class="fas fa-tablet-alt"></span
                      ></span>
                      Tablet Web <a href="#" class="h6">10%</a>
                    </h6>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div class="d-block ms-auto">
                  ...
                  <div class="d-flex align-items-center text-right">
                    <span
                      class="shape-xs rounded-circle bg-secondary me-2"
                    ></span>
            ...
            <div class="card border-light shadow-sm">
              ...
              >
                ...
                <div class="d-block ms-auto">
                  <div class="d-flex align-items-center text-right mb-2">
                    <span class="shape-xs rounded-circle bg-dark me-2"></span>
                    <span class="fw-normal small">Google</span>
                  </div>
                  <div class="d-flex align-items-center text-right mb-2">
                    <span
                      class="shape-xs rounded-circle bg-secondary me-2"
                    ></span>
                    <span class="fw-normal small">Yahoo</span>
                  </div>
                  <div class="d-flex align-items-center text-right mb-2">
                    <span
                      class="shape-xs rounded-circle bg-tertiary me-2"
                    ></span>
                    <span class="fw-normal small">Yandex</span>
                  </div>
                </div>
              </div>
              <div class="card-body p-2">
                <div
                  class="ct-chart-traffic-source ct-golden-section ct-series-a"
                ></div>
              </div>
            </div>
          </div>
            ...
            <div class="card border-light shadow-sm">
              ...
              >
                ...
                <div class="d-block ms-auto">
                  ...
                  <div class="d-flex align-items-center text-right mb-2">
                    <span class="shape-xs rounded-circle bg-dark me-2"></span>
                    <span class="fw-normal small">Paid</span>
                  </div>
                </div>
              </div>
              <div class="card-body p-2">
                <div
                  class="ct-chart-distribution ct-golden-section ct-series-a"
                ></div>
              </div>
            </div>
          </div>
          ...
          <div class="col-12 col-xl-8 mb-4">
            <div class="row">
                    ...
                    <table class="table align-items-center table-flush">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <span
                              class="fas fa-arrow-up text-danger me-3"
                            ></span>
                            42,55%
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            <span
                              class="fas fa-arrow-down text-success me-3"
                            ></span>
                            43,52%
                          </td>
                        </tr>
              ...
              <div class="col-12 col-lg-6 mb-4">
                <div class="card border-light shadow-sm">
                  <div
                    class="card-header border-bottom border-light d-flex justify-content-between"
                  >
                    <h2 class="h5 mb-0">Team members</h2>
                    <a href="../users.html" class="btn btn-sm btn-secondary"
                      >See all</a
                    >
                  </div>
                  <div class="card-body">
                    <ul class="list-group list-group-flush list my--3">
                      ...
                      <li class="list-group-item px-0">
                        <div class="row align-items-center">
                          <div class="col-auto">
                            <a href="../users.html" class="user-avatar"
                              ><img
                                class="rounded-circle"
                                alt="Image placeholder"
                          ...
                          <div class="col text-right">
                            <a
                              ...
                              class="btn btn-sm btn-tertiary"
                              ><i class="fas fa-comment me-1"></i> Message</a
                            >
                          </div>
                        </div>
                      </li>
                ...
                <div class="card border-light shadow-sm">
                  ...
                  <div class="card-body">
                    <div class="row align-items-center mb-4">
                      <div class="col-auto">
                        <span class="icon icon-md text-purple"
                    ...
                    <div class="row align-items-center mb-4">
                      <div class="col-auto">
                        <span class="icon icon-md text-success"
                    ...
                    <div class="row align-items-center mb-4">
                      <div class="col-auto">
                        <span class="icon icon-md text-info"
              ...
              <div class="col-12">
                <div class="card border-light shadow-sm">
                  ...
                  <div class="card-body">
                    <div
                      class="row align-items-center d-block d-sm-flex border-bottom border-light pb-4 mb-4"
                    >
                      ...
                      <div class="col">
                        <a href="../calendar.html">
                          <h3 class="h5">Newmarket Nights</h3> </a
                        ><span
                          >Organized by
                        ...
                        <span class="small fw-bold"
                          >Place: Cambridge Boat Club, Cambridge</span
                        >
                      </div>
                    </div>
                    <div
                    ...
                    >
                      ...
                      <div class="col">
                        <a href="../calendar.html">
                          <h3 class="h5 mb-0">Noco Hemp Expo</h3> </a
                        ><span
                          >Organized by
                          <a href="#!" class="text-700"
                            >University of Oxford</a
                        ...
                        <span class="small fw-bold"
                          >Place: Denver Expo Club, USA</span
                        >
                      </div>
                    </div>
                    <div class="row d-block d-sm-flex align-items-center">
                      ...
                      <div class="col">
                        ...
                        <span class="small fw-bold"
                          >Place: Toronto , Canada</span
                        >
                      </div>
                    </div>
                  </div>
                  <div class="card-footer border-top border-light text-center">
                    <a class="fw-bold text-primary" href="../calendar.html"
                      >See all</a
                    >
                  </div>
                </div>
                ...
                <div class="card-body">
                  ...
                  >
                    ...
                    <div>
                      <a href="#" class="text-primary fw-bold"
                        >#755<span class="fas fa-chart-line ms-2"></span
                      ></a>
                    </div>
                  </div>
                  <div
                  ...
                  >
                    <div>
                      <h6 class="mb-0">
                        <span class="icon icon-xs me-3"
                          ><span class="fas fa-flag-usa"></span></span
                        >Country Rank
                      </h6>
                      <div class="small card-stats">
                        United States<span
                          class="icon icon-xs text-success ms-2"
                    ...
                    <div>
                      <a href="#" class="text-primary fw-bold"
                        >#32<span class="fas fa-chart-line ms-2"></span
                      ></a>
                    </div>
                  </div>
                  <div
                  ...
                  >
                    <div>
                      <h6 class="mb-0">
                        <span class="icon icon-xs me-3"
                          ><span class="fas fa-folder-open"></span></span
                        >Category Rank
                      </h6>
                      <a href="#" class="small card-stats"
                        >Travel > Accomodation</a
                      >
                    </div>
                    <div>
                      <a href="#" class="text-primary fw-bold"
                        >#16<span class="fas fa-chart-line ms-2"></span
                      ></a>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-body">
                  ...
                  <div class="d-block">
                    <div class="d-flex align-items-center pt-3 me-5">
                      <div
                        class="icon icon-shape icon-sm icon-shape-danger rounded me-3"
                      >
                    ...
                    <div class="d-flex align-items-center pt-3">
                      <div
                        class="icon icon-shape icon-sm icon-shape-quaternary rounded me-3"
                      >
                    ...
                    <div class="col">
                      <div class="progress-wrapper">
                        <div class="progress-info">
                          <div class="h6 mb-0">
                            United States
                            <span class="text-gray font-small">(272.109)</span>
                          </div>
                          <div class="small fw-bold text-dark">
                            <span>34 %</span>
                          </div>
                    ...
                    <div class="col">
                      <div class="progress-wrapper">
                        <div class="progress-info">
                          <div class="h6 mb-0">
                            Canada
                            <span class="text-gray font-small">(160.064)</span>
                          </div>
                          <div class="small fw-bold text-dark">
                            <span>20 %</span>
                          </div>
                    ...
                    <div class="col">
                      <div class="progress-wrapper">
                        <div class="progress-info">
                          <div class="h6 mb-0">
                            Germany
                            <span class="text-gray font-small">(120.048)</span>
                          </div>
                          <div class="small fw-bold text-dark">
                            <span>15 %</span>
                          </div>
                    ...
                    <div class="col">
                      <div class="progress-wrapper">
                        <div class="progress-info">
                          <div class="h6 mb-0">
                            France
                            <span class="text-gray font-small">(100.048)</span>
                          </div>
                          <div class="small fw-bold text-dark">
                            <span>8 %</span>
                          </div>
                    ...
                    <div class="col">
                      <div class="progress-wrapper">
                        <div class="progress-info">
                          <div class="h6 mb-0">
                            Japan
                            <span class="text-gray font-small">(56.022)</span>
                          </div>
                          <div class="small fw-bold text-dark">
                            <span>7 %</span>
                          </div>
                    ...
                    <div class="col">
                      <div class="progress-wrapper">
                        <div class="progress-info">
                          <div class="h6 mb-0">
                            Italy
                            <span class="text-gray font-small">(48.019)</span>
                          </div>
                          <div class="small fw-bold text-dark">
                            <span>6 %</span>
                          </div>
                    ...
                    <div class="col">
                      <div class="progress-wrapper">
                        <div class="progress-info">
                          <div class="h6 mb-0">
                            Netherlands
                            <span class="text-gray font-small">(40.016)</span>
                          </div>
                          <div class="small fw-bold text-dark">
                            <span>5 %</span>
                          </div>
                    ...
                    <div class="col">
                      <div class="progress-wrapper">
                        <div class="progress-info">
                          <div class="h6 mb-0">
                            Sweden
                            <span class="text-gray font-small">(26.016)</span>
                          </div>
                          <div class="small fw-bold text-dark">
                            <span>3 %</span>
                          </div>
