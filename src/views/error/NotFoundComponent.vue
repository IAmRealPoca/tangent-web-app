          ...
          >
            <div>
              <img
                  ...
                  src="https://demo.themesberg.com/volt-pro/assets/img/illustrations/404.svg"
                  alt="404 not found"
              />
              <h1 class="mt-5">
              ...
              <a
                  class="btn btn-dark animate-hover"
                  @click="goBack"
              ><i class="fas fa-chevron-left me-3 ps-2 animate-left-3"></i
              >Go back home</a
              >
            </div>
          </div>
