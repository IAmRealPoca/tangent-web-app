          ...
          <div class="col-12 col-xl-9">
            <div class="table-settings mb-4">
              <div class="row justify-content-between align-items-center">
                <div class="col-3 col-lg-11 text-right">
              ...
              <table class="table user-table table-hover align-items-center">
                <thead>
                  <tr>
                    ...
                    <th class="border-bottom">Informations</th>
                    <th class="border-bottom">Status</th>
                    <th class="border-bottom">Date applied</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    ...
                    <td><span class="fw-normal text-success">Hired</span></td>
                    <td>
                      <div class="btn-group">
                        <button
                  ...
                  <tr>
                    ...
                    <td><span class="fw-normal text-info">Reviewed</span></td>
                    <td>
                      <div class="btn-group">
                        <button
                          class="btn btn-link text-dark dropdown-toggle dropdown-toggle-split m-0 p-0"
                  ...
                  <tr>
                    ...
                    <td><span class="fw-normal text-warning">Not reviewed</span></td>
                    <td>
                      <div class="btn-group">
                        <button
                          class="btn btn-link text-dark dropdown-toggle dropdown-toggle-split m-0 p-0"
